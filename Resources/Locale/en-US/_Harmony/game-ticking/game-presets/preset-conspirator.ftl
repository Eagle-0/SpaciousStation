...
conspirator-role-greeting = 
    ...
    You start knowing the identities of the other conspirators, find a way to contact them without arousing suspicion.
...
conspirator-radio-implant = Complete your objective at all costs.
